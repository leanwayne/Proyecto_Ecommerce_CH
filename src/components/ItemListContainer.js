...
const itemsMock = [
    {
      ...
      pictureUrl: "https://http2.mlstatic.com/D_NQ_NP_650191-MLA31114378252_062019-O.webp",
      stock: 6,
      initial: 1,
      categoryId: 'jeans'
    },
    {
      ...
      pictureUrl: "https://http2.mlstatic.com/D_NQ_NP_890124-MLA40362509323_012020-O.webp",
      stock: 12,
      initial: 1,
      categoryId: 'remeras'
    },
    {
      ...
      pictureUrl: 'https://http2.mlstatic.com/D_NQ_NP_809543-MLA41634735796_052020-O.webp',
      stock: 5,
      initial: 1,
      categoryId: 'camperas'
    },
...
export default function ItemListContainer({ greeting }) {
  ...
  return (
    <div>
      <h1>{greeting}</h1>
      {!items.length ? <h2>Loading...</h2> : <ItemList items={id ? items.filter(item => item.categoryId === id) : items} />}
    </div>
  );
}
